package com.example.lzk.userservice.config;
...
public class SwaggerConfig {
    ...
    public Docket createRestfulApi() {//api文档实例
        return new Docket(DocumentationType.SWAGGER_2)//文档类型：DocumentationType.SWAGGER_2
                ...
                .select()//构建api选择器
                .apis(RequestHandlerSelectors.basePackage("com.example.lzk.userservice"))//api选择器选择api的包
    ...
    private ApiInfo apiInfo() {//接口的相关信息
        return new ApiInfoBuilder()
                .title("项目接口文档")
                .description("goldenAnt Tool API")
